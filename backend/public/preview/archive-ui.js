(function(root){
 ...
 const api={states,stateCode,wordCount,highlight,excerpt,sortBooks,provider,mergeMetadata,icon};if(typeof module!=='undefined'&&module.exports)module.exports=api;else root.ArchiveUI=api;
