...
function settings(){
 shell('<h1>设置</h1><section class="settings-row"><div><h2>本地备份</h2><p class="muted">'+books.length+' 本书</p></div><button id="export">导出</button></section><section class="settings-row"><div><h2>AI 总览</h2><p class="muted">DeepSeek · 点击整理时发送本书笔记</p><p id="aiConfigStatus" role="status" class="config-status">正在检查配置…</p></div></section>');
