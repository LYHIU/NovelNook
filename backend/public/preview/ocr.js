...
function screenshotImport(){
 shell('<button class="back" id="ocrBack">← 找书</button><h1>截图识别</h1><label class="field-label" for="screenshotFile">作品详情截图</label><input id="screenshotFile" type="file" accept="image/png,image/jpeg,image/webp" aria-label="选择作品截图"><div id="ocrArea" aria-live="polite"></div>');
 $('#ocrBack').onclick=add;
